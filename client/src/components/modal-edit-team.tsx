...
const PlayerCard = () => {
  return (
    <div className="border h-16 rounded-lg border-inactive flex items-center justify-start gap-4 px-2">
      <div className="relative w-fit cursor-pointer group border border-[#282828] hover:border-[#484848] rounded-xl flex items-center justify-center group flex-shrink-0">
        <Image
          src="/icon.svg"
          alt="image"
          width={10}
          height={10}
          className="size-10 bg-[#282828] backdrop-blur-lg rounded-xl"
        />
